...
var ea="function"==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)};
function fa(a){a=["object"==typeof window&&window,"object"==typeof self&&self,"object"==typeof global&&global,a];for(var b=0;b<a.length;++b){var c=a[b];if(c&&c.Math==Math)return c}throw Error("Cannot find global object");}
var ha=fa(this);function r(a,b){if(b){for(var c=ha,d=a.split("."),e=0;e<d.length-1;e++){var f=d[e];f in c||(c[f]={});c=c[f]}d=d[d.length-1];e=c[d];f=b(e);f!=e&&null!=f&&ea(c,d,{configurable:!0,writable:!0,value:f})}}
...
;var C;a:{var ta=t.navigator;if(ta){var ua=ta.userAgent;if(ua){C=ua;break a}}C=""};function va(a,b){for(var c in a)b.call(void 0,a[c],c,a)}
function wa(a,b){var c=ka(b),d=c?b:arguments;for(c=c?0:1;c<d.length;c++){if(null==a)return;a=a[d[c]]}return a}
function xa(){var a=ya,b={},c;for(c in a)b[c]=a[c];return b}
var za="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function Aa(a,b){for(var c,d,e=1;e<arguments.length;e++){d=arguments[e];for(c in d)a[c]=d[c];for(var f=0;f<za.length;f++)c=za[f],Object.prototype.hasOwnProperty.call(d,c)&&(a[c]=d[c])}}
;function E(a,b){this.b=a===Ba&&b||"";this.a=Ca}
var Ca={},Ba={},F=new E(Ba,"");function G(a,b){this.b=a===Da&&b||"";this.a=Ea}
var Ea={},Da={};function H(){this.a="";this.b=Fa}
var Fa={};function I(a){var b=new H;b.a=a;return b}
I("<!DOCTYPE html>");var J=I("");I("<br>");function Ga(a){var b=new G(Da,F instanceof E&&F.constructor===E&&F.a===Ca?F.b:"type_error:Const");a.src=(b instanceof G&&b.constructor===G&&b.a===Ea?b.b:"type_error:TrustedResourceUrl").toString()}
...
var Wa;
function Xa(){var a=t.MessageChannel;"undefined"===typeof a&&"undefined"!==typeof window&&window.postMessage&&window.addEventListener&&-1==C.indexOf("Presto")&&(a=function(){var e=Ha();e.style.display="none";Ga(e);document.documentElement.appendChild(e);var f=e.contentWindow;e=f.document;e.open();e.write(J instanceof H&&J.constructor===H&&J.b===Fa?J.a:"type_error:SafeHtml");e.close();var g="callImmediate"+Math.random(),k="file:"==f.location.protocol?"*":f.location.protocol+"//"+f.location.host;e=
...
!(c=!x(t.setImmediate))&&(c=t.Window&&t.Window.prototype)&&(c=-1==C.indexOf("Edge")&&t.Window.prototype.setImmediate==t.setImmediate);c?(Wa||(Wa=Xa()),Wa(b)):t.setImmediate(b)}}
...
;function Ab(a){var b=[];va(a,function(c,d){var e=encodeURIComponent(String(d)),f;"array"==w(c)?f=c:f=[c];B(f,function(g){""==g?b.push(e):b.push(e+"="+encodeURIComponent(String(g)))})});
return b.join("&")}
...
return h}
;function Zb(){var a=xa(),b;return R(new P(function(c,d){a.m=function(e){Kb(e)?c(e):d(new W("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
q(Y,A);Y.prototype.name="BiscottiMissingError";var ya={format:"RAW",method:"GET",timeout:5E3,withCredentials:!0},Z=null;function cc(){if("1"===wa(U("PLAYER_CONFIG",{}),"args","privembed"))return jb(Error("Biscotti ID is not available in private embed mode"));Z||(Z=R(Zb().then(dc),function(a){return ec(2,a)}));
return Z}
